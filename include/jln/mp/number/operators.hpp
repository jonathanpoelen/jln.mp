...
namespace jln::mp::emp
{
  ...
  template<class L, class C = mp::identity>
  inline constexpr int_t or_seq_v = unpack<L, mp::or_<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t and_seq_v = unpack<L, mp::and_<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t or_left_seq_v = unpack<L, mp::left_or<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t and_left_seq_v = unpack<L, mp::left_and<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t add_seq_v = unpack<L, mp::add<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t add0_seq_v = unpack<L, mp::add0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_add_seq_v = unpack<L, mp::left_add<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_add0_seq_v = unpack<L, mp::left_add0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t sub_seq_v = unpack<L, mp::sub<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t sub0_seq_v = unpack<L, mp::sub0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t lshift_seq_v = unpack<L, mp::lshift<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t lshift0_seq_v = unpack<L, mp::lshift0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t rshift_seq_v = unpack<L, mp::rshift<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t rshift0_seq_v = unpack<L, mp::rshift0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t mul_seq_v = unpack<L, mp::mul<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t mul0_seq_v = unpack<L, mp::mul0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t mul1_seq_v = unpack<L, mp::mul1<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_mul_seq_v = unpack<L, mp::left_mul<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_mul0_seq_v = unpack<L, mp::left_mul0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_mul1_seq_v = unpack<L, mp::left_mul1<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t div_seq_v = unpack<L, mp::div<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t div0_seq_v = unpack<L, mp::div0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t div1_seq_v = unpack<L, mp::div1<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t mod_seq_v = unpack<L, mp::mod<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t mod0_seq_v = unpack<L, mp::mod0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t mod1_seq_v = unpack<L, mp::mod1<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t xor_seq_v = unpack<L, mp::xor_<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t xor0_seq_v = unpack<L, mp::xor0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_xor_seq_v = unpack<L, mp::left_xor<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_xor0_seq_v = unpack<L, mp::left_xor0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t bit_and_seq_v = unpack<L, mp::bit_and<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t bit_and0_seq_v = unpack<L, mp::bit_and0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_bit_and_seq_v = unpack<L, mp::left_bit_and<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_bit_and0_seq_v = unpack<L, mp::left_bit_and0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t bit_or_seq_v = unpack<L, mp::bit_or<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t bit_or0_seq_v = unpack<L, mp::bit_or0<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_bit_or_seq_v = unpack<L, mp::left_bit_or<C>>::value;

  template<class L, class C = mp::identity>
  inline constexpr int_t left_bit_or0_seq_v = unpack<L, mp::left_bit_or0<C>>::value;
