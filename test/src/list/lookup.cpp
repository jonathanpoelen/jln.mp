...
#undef SEQ
  ...
  using b300 = emp::make_int_sequence_c<300, lift<build_indexed_v>>;
  ut::same<number<2  >, b300::f<2>>();
  ut::same<number<100>, b300::f<100>>();
  ut::same<number<200>, b300::f<200>>();
  ut::same<number<299>, b300::f<299>>();
  ut::not_invocable<ut::sfinae<emp::make_int_sequence_c<300, lift<build_indexed>>>::f<number<300>>>();

  using b5000 = emp::make_int_sequence_c<5000, lift<build_indexed_v>>;
  ...
  ut::not_invocable<ut::sfinae<emp::make_int_sequence_c<5000, lift<build_indexed>>>::f<number<5000>>>();
#endif
}
