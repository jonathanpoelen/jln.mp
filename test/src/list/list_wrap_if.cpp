...
TEST()
{
  ...
  test_context<list_wrap_if<pred1>, smp::list_wrap_if<pred1>, 0>()
    .test<list<int>, int>()
    .test<list<>, char>()
    .not_invocable<>()
  ...
  test_context<list_wrap_if<pred2>, smp::list_wrap_if<pred2>, 0>()
  ...
  test_context<list_wrap_if_not<pred1>, smp::list_wrap_if_not<pred1>, 0>()
    .test<list<>, int>()
    .test<list<char>, char>()
    .not_invocable<>()
    .not_invocable<int, int>()
  ...
  test_context<list_wrap_if_not<pred2>, smp::list_wrap_if_not<pred2>, 0>()
    .test<list<>, int, int>()
