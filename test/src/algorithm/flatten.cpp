...
TEST()
{
  ...
  test_mulary_pack<flatten, cfe<list>>();
  test_mulary_pack<flatten_once, cfe<list>>();
  ...
  test_context<flatten_once<cfe<other_list>>, smp::flatten_once<cfe<other_list>>>()
    .test<seq_0_1_2_3, _0, _1, _2, _3>()
    .test<list<_0, list<list<_1>, _2>, _3>, _0, list<list<_1>, _2>, _3>()
    .test<list<_0, list<_1>, _1, list<_2>, _3>,
      _0, other_list<list<_1>, _1>, list<_2>, _3>()
  ...
  ut::not_invocable<smp::flatten_once<cfe<list>, bad_function>, seq_0>();
  ut::not_invocable<smp::flatten_once<cfe<list>, bad_function>, seq_0, seq_0_2>();
