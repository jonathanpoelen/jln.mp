...
TEST()
{
  ...
  test_binary_pack<upper_bound, void>();
  test_mulary_pack<upper_bound, void, listify>();
  test_mulary_pack<upper_bound, void, listify, listify>();
  ...
  test_context<upper_bound_than_c<2, smp::identity, smp::always<void>>, void, 0>()
    .test<void>()
    .test<void, _0>()
    .test<_3, _0, _1, _2, _3>()
    .not_invocable<_3, _4>()
