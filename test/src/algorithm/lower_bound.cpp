...
TEST()
{
  ...
  test_binary_pack<lower_bound, _1>();
  test_mulary_pack<lower_bound, _1, listify>();
  test_mulary_pack<lower_bound, _1, listify, listify>();
  ...
  ut::not_invocable<smp::lower_bound<void, smp::always<na>>, _1>();
