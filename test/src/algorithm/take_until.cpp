...
TEST()
{
  ...
  ut::not_invocable<smp::take_until<smp::always<_3>>, _1, _1, _1>();
...
TEST()
{
  ...
  ut::not_invocable<smp::take_until_extended_by_n_c<2, smp::always<_3>>, _1, _1, _1>();
...
TEST()
{
  ...
  ut::not_invocable<smp::take_inclusive_until<smp::always<_3>>, _1, _1, _1>();
