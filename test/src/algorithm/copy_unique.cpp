...
TEST()
{
  ...
  test_context<
    copy_unique_if<each<first, first, cfe<std::is_same>>>,
    smp::copy_unique_if<smp::each<smp_first, smp_first, smp::cfe<std::is_same>>>,
  ...
  ut::not_invocable<smp::copy_unique_if<cfe<std::is_same>, bad_function>, _1, _1, _1, _1>();
}
