...
TEST()
{
  ...
  test_context<circulant_matrix<>, smp::circulant_matrix<>>()
    ...
    .test<list<emp::numbers<0, 1, 2>,
               emp::numbers<2, 0, 1>,
               emp::numbers<1, 2, 0>>, _0, _1, _2>()
    .test<list<emp::numbers<0, 1, 2, 3>,
               emp::numbers<3, 0, 1, 2>,
               emp::numbers<2, 3, 0, 1>,
               emp::numbers<1, 2, 3, 0>>, _0, _1, _2, _3>()
  ...
  test_context<circulant_matrix_with<add<>>, smp::circulant_matrix_with<smp::add<>>>()
    .test<list<>>()
    .test<list<_0>, _0>()
  ...
  ut::not_invocable<smp::circulant_matrix<bad_function>, _1>();
}
