...
TEST()
{
  ...
  test_mulary_pack<drop_until_xs>();
  test_mulary_pack<drop_until_xs, is<int>>();
  test_mulary_pack<drop_until_xs, is<int>, identity>();
  ...
  test_context<
    drop_until_xs<identity, mp::listify, mp::always<void>>,
    smp::drop_until_xs<smp::identity, smp::listify, smp::always<void>>
  >()
    .test<void>()
    .test<void, _0>()
    .test<seq_1, _1>()
...
TEST()
{
  ...
  test_mulary_pack<drop_inclusive_until_xs>();
  test_mulary_pack<drop_inclusive_until_xs, is<int>>();
  test_mulary_pack<drop_inclusive_until_xs, is<int>, identity>();
  ...
  test_context<
    drop_inclusive_until_xs<identity, mp::listify, mp::always<void>>,
    smp::drop_inclusive_until_xs<smp::identity, smp::listify, smp::always<void>>
  >()
    .test<void>()
    .test<void, _0>()
    .test<list<>, _1>()
...
TEST()
{
  ...
  test_mulary_pack<partial_drop_until_xs, _9>();
  test_mulary_pack<partial_drop_until_xs, _9, is<int>>();
  test_mulary_pack<partial_drop_until_xs, _9, is<int>, identity>();
  ...
  test_context<
    partial_drop_until_xs_c<2, identity, mp::listify, mp::always<void>>,
    smp::partial_drop_until_xs_c<2, smp::identity, smp::listify, smp::always<void>>
  >()
    .test<void>()
    .test<void, _0>()
    .test<seq_1, _1>()
...
TEST()
{
  ...
  test_mulary_pack<partial_drop_inclusive_until_xs, _9>();
  test_mulary_pack<partial_drop_inclusive_until_xs, _9, is<int>>();
  test_mulary_pack<partial_drop_inclusive_until_xs, _9, is<int>, identity>();
  ...
  test_context<
    partial_drop_inclusive_until_xs_c<2, identity, mp::listify, mp::always<void>>,
    smp::partial_drop_inclusive_until_xs_c<2, smp::identity, smp::listify, smp::always<void>>
  >()
    .test<void>()
    .test<void, _0>()
    .test<list<>, _1>()
